...
/*
 * Class:     com_dhy_bspatch_PatchUtils
 * Method:    patch
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL
Java_com_dhy_versionchecker_PatchUtils_patch(JNIEnv *env, jclass clazz, jstring old, jstring new, jstring patch) {
...
JNIEXPORT jint JNICALL
Java_com_dhy_versionchecker_PatchUtils_patchTest(JNIEnv *env, jclass clazz, jstring old_apk_path, jstring new_apk_path, jstring patch_path) {
    return 0;
}